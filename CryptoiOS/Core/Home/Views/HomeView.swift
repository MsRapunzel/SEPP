...
struct HomeView: View {
    ...
    /// A state variable indicating whether the portfolio view should be shown.
    @State private var showPortfolioView: Bool = false // new sheet
    
    /// A state variable indicating whether the settings view should be shown.
...
extension HomeView {
    ...
    /// A view representing the list of portfolio coins.
    ...
    /// A view displaying a message when the portfolio is empty.
    private var notConnectedToWiFiText: some View {
        Text("Seems that you are not connected to a Wi-Fi. Please, connect and try again. 🧐")
            .font(.callout)
    ...
    /// A view displaying a message when the portfolio is empty.
    private var tooManyRequestsText: some View {
        Text("You have done too many requests recently. Please, retry in one minute. 🧐")
            .font(.callout)
            .foregroundColor(Color.theme.accent)
            .fontWeight(.medium)
            .multilineTextAlignment(.center)
